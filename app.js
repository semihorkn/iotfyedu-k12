...
fitStyles.rel='stylesheet'; fitStyles.href='fit-fixes.css';
...
const ecosystemGrid=$('.feature-grid');
ecosystemGrid.outerHTML=`<div class="ecosystem-products">
  <div class="ecosystem-label"><span>FİZİKSEL ÜRÜNLER</span><p>Öğrencinin dokunduğu, ölçtüğü ve ürettiği sınıf araçları.</p></div>
  <div class="product-grid">
    <article class="product-card product-sense"><div class="product-media"><img src="assets/sense-miner.png" alt="Sense Miner çoklu sensör cihazı"><span class="product-index">01</span></div><div class="product-copy"><span class="product-type">VERİ TOPLAMA</span><h3>Sense Miner</h3><p>Sıcaklık, nem, mesafe, ışık, hava kalitesi ve daha fazlasını gerçek zamanlı ölçer; öğrencinin çevresini veriye dönüştürmesini sağlar.</p><div class="product-tags"><span>10+ sensör</span><span>Canlı veri</span><span>IoT</span></div></div></article>
    <article class="product-card product-circuit"><div class="product-media"><img src="assets/easy-circuit.jpg" alt="Easy Circuit elektronik devre eğitim kartı"><span class="product-index">02</span></div><div class="product-copy"><span class="product-type">FİZİKSEL HESAPLAMA</span><h3>Easy Circuit</h3><p>Breadboard, motor, joystick ve elektronik bileşenleri tek eğitim kartında buluşturur; devre kurmayı ve kodlamayı erişilebilir kılar.</p><div class="product-tags"><span>Devre tasarımı</span><span>Motor kontrolü</span><span>Kodlama</span></div></div></article>
    <article class="product-card product-lab"><div class="product-media"><img src="assets/mini-lab.png" alt="IoT fen bilimleri deneyleri için Mini Lab"><span class="product-index">03</span></div><div class="product-copy"><span class="product-type">IOT FEN DENEYLERİ</span><h3>Mini Lab</h3><p>Fen bilimleri deney düzeneklerini güvenli, düzenli ve tekrar kullanılabilir bir yapıda sunar; ölçüm verilerini IoT ile görünür hale getirir.</p><div class="product-tags"><span>Fen deneyleri</span><span>Modüler yapı</span><span>Ölçüm</span></div></div></article>
  </div>
  <section class="digital-worlds"><div class="digital-intro"><span class="product-type">LMS İÇİNDE DİJİTAL DÜNYALAR</span><h3>Fiziksel deneyden<br>dijital üretime.</h3><p>Öğrenciler aynı hesapla kodlama, devre kurma, veri analizi ve erken yaş etkinliklerine ulaşır. Öğretmen tüm süreci tek panelden takip eder.</p><a href="#demo">Platformları keşfet ↗</a></div><div class="platform-grid">
    <article class="platform-card code-studio"><span class="platform-mark">{ }</span><div><small>KODLAMA</small><h4>IoTfy Code<br>Studio</h4><p>Algoritma, blok ve metin tabanlı kodlama.</p></div><b>CS</b></article>
    <article class="platform-card circuits"><span class="platform-mark">⌁</span><div><small>DEVRE</small><h4>IoTfy Code<br>Circuits</h4><p>Sanal ve fiziksel devre tasarımı.</p></div><b>CC</b></article>
    <article class="platform-card data-science"><span class="platform-mark">▥</span><div><small>VERİ</small><h4>IoTfy Code<br>Data Science</h4><p>Veri analizi, grafikler ve projeler.</p></div><b>DS</b></article>
    <article class="platform-card jr-code"><span class="platform-mark">✦</span><div><small>ERKEN YAŞ</small><h4>IoTfy Jr<br>Code</h4><p>Oyunla algoritma ve üretim.</p></div><b>JR</b></article>
  </div></section>
</div>`;
